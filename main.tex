...
\definecolor{pycmd}{rgb}{1.0, 0.75, 0.0}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% importa pacchetti
\usepackage{usepkg}
%%
\renewbibmacro*{cite}{%
...
\title{Metodi Computazionali (Python, Parallel computing, Machine learning, $C++$): Febbraio 2020.}
...
\part{Programmazione}\linkdest{programmation}
\subfile{oop}
\subfile{parallelization}

\part{Machine}\linkdest{ML}

\part{Projects}\linkdest{projects}
